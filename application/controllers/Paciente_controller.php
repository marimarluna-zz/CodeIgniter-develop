...
public function tabla_informe()
 ...
 function busqueda(){
  ...
  $this->load->model('paciente_model');
  $data_pacient['datos'] = $this->paciente_model->buscar_paciente(); // recuerda lo de data['datos'] que es con lo que enviamos informacion
  ...
  $this->load->view('menu_navegacion_espe',$data);  
  $this->load->view('c_informe',$data_pacient);
