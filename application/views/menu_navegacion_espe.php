      ...
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <form name="form_prueba" action="<?= base_url().'login/inicio'?>" method="POST"><input  style = "display:none" type="text" id="usuario" name="usuario" value="<?php echo $usuario; ?>"  class="form-control" >
			...
			<button type="submit" value='login' style="margin-top:9%" name="datos" class="btn btn-info"><img src="<?=base_url().'assents/img/nhisres100.png'?>" style="max-width:40px"></button>    
		</form>	
        </div>
