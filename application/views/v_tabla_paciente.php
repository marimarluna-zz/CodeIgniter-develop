...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
                <form name="form_prueba" action="<?= base_url().'paciente_controller/buscar_t'?>" method="POST">
                    <div class=" col-md-6 ">
                        <input type="text" placeholder="Buscar por nombre/cedula/apellido" id="busqueda" name="busqueda" class="form-control col-sm-2" required> 
                    </div>
                    <div class="col-sm-4 form-group">
                        <select requird class="form-control " name="filtro" id="filtro">
                            <option value="ci_paciente" >Cedula</option>
                            <option value="nombre_p" >Nombre</option>
                            <option value="Apellido_p" >Apellido</option>
                ...
                <form action="<?php echo base_url(); ?>paciente_controller/tabla">
